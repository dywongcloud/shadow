...
import { MoreHorizontal, RotateCcw, RefreshCw, Trash2, Loader2 } from "lucide-react";

/** The "⋯" menu at the end of a deployment row — Instant Rollback / Redeploy /
 *  Delete. Mirrors ProjectMenu: the menu is portaled and fixed-positioned at the
 *  trigger so it overlays everything and is never clipped by the table's overflow. */
