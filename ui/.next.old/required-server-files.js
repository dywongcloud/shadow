self.__SERVER_FILES_MANIFEST={
  ...
  "config": {
    ...
    "outputFileTracingRoot": "/Users/dylanwong/fluid/hive/ui",
    ...
    "turbopack": {
      "root": "/Users/dylanwong/fluid/hive/ui"
    },
    "distDirRoot": ".next",
    "_originalRewrites": {
      "beforeFiles": [],
      "afterFiles": [
        ...
        {
          "source": "/cloud/:path*",
          "destination": "https://api.shadw.cloud/:path*"
        },
        {
          "source": "/ops/:path*",
          "destination": "https://api.shadw.cloud/:path*"
  ...
  "appDir": "/Users/dylanwong/fluid/hive/ui",
  "relativeAppDir": "",
  "files": [
    ".next/package.json",
