...
export function AdminAuditClient({ initialEvents }: { initialEvents: AuditEvent[] | null }) {
  const { data: events } = useOpsPoll<AuditEvent[]>("/v1/admin/audit", 4000, true, initialEvents);
